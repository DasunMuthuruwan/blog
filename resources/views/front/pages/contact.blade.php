...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="content mb-5">
            ...
            <p>If you have any questions, suggestions, or just want to say hello — don’t hesitate to reach out. We're always here to help and listen.</p>
    ...
    <div class="col-md-6">
        <form method="POST" action="{{ route('send_email') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-control" placeholder="e.g. Jane Doe" value="{{ old('name') }}">
                @error('name')
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" id="email" class="form-control" placeholder="e.g. jane@example.com" value="{{ old('email') }}">
                @error('email')
                    <span class="text-danger small">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="subject" id="subject" class="form-control" placeholder="e.g. Business Inquiry" value="{{ old('subject') }}">
                @error('subject')
                    <span class="text-danger small">{{ $message }}</span>
                @enderror
            </div>
