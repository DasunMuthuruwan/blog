    ...
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 text-right">
                <a href="javascript:;" wire:click="addAdvertisement()" class="btn btn-primary btn-sm">
                    <i class="icon-copy bi bi-plus-circle mr-1"></i>Add advertisements
                </a>
            </div>
        </div>
    </div>
    <div class="card-box pb-20 mb-4">
        <div class="table-responsive mt-3">
            <table class="table table-striped table-auto table-sm table-condensed">
                ...
                <tbody id="sortable_advertisements">
                    @forelse ($ads as $ad)
                        <tr data-index="{{ $ad->id }}" data-ordering="{{ $ad->ordering }}">
                            <td scope="row">#{{ $ad->id }}</td>
                            <td>
                                @if ($ad->image)
                                    <a href="{{ asset("images/ads/{$ad->image}") }}" target="_blank">
            ...
            <form class="modal-content"
                ...
                <div class="modal-body">
                    ...
                    <div class="custom-control custom-checkbox mb-5">
                        ...
                        <label for="customCheck" class="custom-control-label">Is Default</label>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-sm">
                        <i class="fa fa-save"></i> {{ $isUpdateAdsMode ? 'Save Changes' : 'Create' }}
                    </button>
                </div>
            </form>
        </div>
